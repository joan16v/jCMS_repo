-- 
-- Estructura de tabla para la tabla `jcms_noticias`
-- 
...
-- 
-- Volcar la base de datos para la tabla `jcms_noticias`
-- 
...
-- 
-- Estructura de tabla para la tabla `jcms_productos`
-- 
...
-- 
-- Volcar la base de datos para la tabla `jcms_productos`
-- 
...
-- 
-- Estructura de tabla para la tabla `jcms_productos_imagenes`
-- 
...
-- 
-- Volcar la base de datos para la tabla `jcms_productos_imagenes`
-- 
...
-- 
-- Estructura de tabla para la tabla `jcms_seccion_index`
-- 
...
-- 
-- Volcar la base de datos para la tabla `jcms_seccion_index`
-- 
...
-- 
-- Estructura de tabla para la tabla `jcms_secciones`
-- 
...
-- 
-- Volcar la base de datos para la tabla `jcms_secciones`
-- 
