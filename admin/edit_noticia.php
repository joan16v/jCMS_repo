...
<div style="margin: 20px;">
    ...
    if( isset( $_GET['id'] ) ) {
        ...
        <input type="hidden" name="id" value="<? echo $id_noticia; ?>" />
        
    	<div>Titulo de la noticia <img src="images/es.png" /></div>
    	<div><input name="nombre" id="nombre" type="text" style="width: 500px;" value="<? echo $rowNoticia->nombre; ?>" /></div>
        
    	<div>Title <img src="images/en.png" /></div>
    	<div><input name="nombre_en" id="nombre_en" type="text" style="width: 500px;" value="<? echo $rowNoticia->nombre_en; ?>" /></div>      
        
        <div style="margin-top: 20px;">Imagen de la noticia</div>
        <? 
            if( $rowNoticia->imagen!="" ) {
                ?><div><img src="../thumbProd.php?foto=images/noticias/<? echo $rowNoticia->imagen; ?>" /></div><?
            }
        ?>
    	...
    	<div><textarea name="descripcion" id="descripcion" style="width: 639px; height:400px;"><? echo $rowNoticia->descripcion; ?></textarea></div>
        
    	<div style="margin-top: 10px;">Description <img src="images/en.png" /></div>
    	<div><textarea name="descripcion_en" id="descripcion_en" style="width: 639px; height:400px;"><? echo $rowNoticia->descripcion_en; ?></textarea></div>        
