...
$base_url = '/var/www/vhosts/mercurioca.com/httpdocs/images/';

// the root path of the upload directory on the server
$uploads_dir = realpath("/var/www/vhosts/mercurioca.com/httpdocs/images/");

// the root path that the files are available from the webserver
// YOU WILL NEED TO CHANGE THIS
$uploads_access_dir = "/var/www/vhosts/mercurioca.com/httpdocs/images/";
